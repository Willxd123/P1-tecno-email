...
public class PUsuarios {
    ...
    /**
     * Parsea una tabla de texto ASCII de NUsuarios a una tabla HTML estilizada.
     */
        ...
        for (String linea : lineas) {
            ...
            for (int col = 0; col < celdas.length; col++) {
                ...
                if (esCabecera) {
                    ...
                    if (celdaText.equalsIgnoreCase("SÍ") || celdaText.equalsIgnoreCase("ACTIVO")) {
                        htmlTable.append("<span class=\"badge badge-si\">SÍ</span>");
                    } else if (celdaText.equalsIgnoreCase("NO") || celdaText.equalsIgnoreCase("INACTIVO")) {
                        htmlTable.append("<span class=\"badge badge-no\">NO</span>");
                    } else if (col == 4 && (celdaText.equalsIgnoreCase("Propietario") || celdaText.equalsIgnoreCase("Secretaria") || celdaText.equalsIgnoreCase("Cliente"))) {
                        // Badge para Rol
