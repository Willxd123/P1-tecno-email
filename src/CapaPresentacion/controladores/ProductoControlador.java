...
public class ProductoControlador {
    ...
    public static boolean canHandle(String comando) {
        ...
        return comando.equals("CU5-01") || comando.equals("REGISTRAR_PRODUCTO") ||
               ...
               comando.equals("REGISTRAR_CATEGORIA") ||
               comando.equals("LISTAR_CATEGORIAS") ||
               comando.equals("ASIGNAR_CATEGORIA") ||
               comando.equals("QUITAR_CATEGORIA");
    }
    ...
    public static String handle(String comando, List<String> parametros) {
        ...
        switch (comando.toUpperCase().trim()) {
            ...
            case "REGISTRAR_CATEGORIA":
                rawResult = NProductos.registrarCategoria(parametros);
                break;

            case "LISTAR_CATEGORIAS":
                rawResult = NProductos.listarCategorias();
                break;

            case "ASIGNAR_CATEGORIA":
                rawResult = NProductos.asignarCategoria(parametros);
                break;

            case "QUITAR_CATEGORIA":
                rawResult = NProductos.quitarCategoria(parametros);
                break;

            default:
                rawResult = "Error: Comando de producto/receta no soportado.";
        }
